...
from master_node.helpers.helpers import test_keypair_exists

class KubernetesMasterStack(Stack):
    def __init__(self, scope: Construct, construct_id: str, vpc: ec2.IVpc, **kwargs) -> None:
        ...
        # user data script to bootstrap master
        with open("master_node/scripts/user_data.sh", "r") as user_data_file:
